...
if (file.exists(acs_rent_trends_file)) {
  ...
  print_progress("WARNING: ACS rent trends missing; run 02h_process_acs_rent_history.R before clustering.")
}
...
if (file.exists(appraisal_trends_file)) {
  ...
  print_progress(
    "WARNING: Adjusted appraisal trends missing; run 02j_process_appraisal_adjusted_trends.R before clustering."
  )
}
